...
$(function () {
    $(function () {
        ...
        $(document).on('mailsent.wpcf7', function () {
            $('.site__form-sent').addClass("site__form-sent_show");
        });
    });
    var n = function (n) {
        var i = n, t = $(".menu__close, .menu-btn"), e = !1, o = function () {
            ...
            e ? $(window).width() > 1023 ? i.getNiceScroll().resize() : (i.getNiceScroll().remove(), i.removeClass("site__header_nice-scroll"), e = !1) : $(window).width() > 1023 && (r(), i.addClass("site__header_nice-scroll"), e = !0)
        }, a = function () {
            o(), s()
        };
        a()
    }, i = function (n) {
        var i = n, t = n.find(".main__slider-next"), e = n.find(".main__slider-prev"), o = i.find(".main__slider"), r = null, s = 1, a = n.find(".main__clients-pagination"), f = i.find(".main__clients"), c = null, l = 5e3, u = 1, d = function () {
        }, p = function () {
            r = new Swiper(o.find(".swiper-container"), {nextButton: t, prevButton: e, slidesPerView: s, loop: !0})
        }, _ = function () {
            c = new Swiper(f.find(".swiper-container"), {
                pagination: a,
                slidesPerView: u,
                loop: !0,
                autoplay: l,
        ...
        var i = n, t = n.find(".project__slider-next"), e = n.find(".project__slider-prev"), o = null, r = 1, s = function () {
        }, a = function () {
            o = new Swiper(i.find(".swiper-container"), {nextButton: t, prevButton: e, slidesPerView: r, loop: !0})
        }, f = function () {
            s(), a()
        };
        f()
    }, e = function (n) {
        var i = this, t = n, e = t.attr("action"), o = t.find("[required]"), r = t.find(".site__form-sent"), s = new XMLHttpRequest, a = function () {
            t.on({
                submit: function () {
                    ...
                    }), t.find(".form-validation__error").length ? !1 : (f(), !1)
                }
            }), o.on({
                focus: function () {
                    var n = $(this);
            ...
            s.abort(), s = $.ajax({
                ...
                type: "get",
                success: function () {
                    r.length && r.addClass("site__form-sent_show")
                },
                error: function (n) {
        ...
        var i = this, t = n, e = t.find(".site__title"), o = e.offset().top, r = e.innerHeight(), s = 0, a = t.find(".filter"), f = a.offset().top, c = a.innerHeight(), l = 0, u = $(window), d = u.scrollTop(), p = function () {
            u.on({
                load: function () {
                    o = e.offset().top, f = a.offset().top, h()
                }, scroll: function () {
                    h()
                }, resize: function () {
                    o = e.offset().top, f = a.offset().top, h()
            ...
            var n;
            s = e.hasClass("fixed") ? e.innerHeight() + parseInt(e.css("margin-bottom")) : 0, l = a.hasClass("fixed") ? a.innerHeight() + parseInt(a.css("margin-bottom")) : 0, n = s + l, t.css({"padding-top": n})
        }, h = function () {
            r = e.innerHeight(), c = a.innerHeight(), d = u.scrollTop(), m(), w(), _()
        }, m = function () {
            d >= f - r ? (a.addClass("fixed"), a.css({top: r})) : (a.removeClass("fixed"), a.css({top: ""}))
        }, w = function () {
            d > o ? e.addClass("fixed") : e.removeClass("fixed")
        }, v = function () {
            h(), p(), t[0].obj = i
        };
        v()
